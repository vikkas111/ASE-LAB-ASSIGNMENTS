...
public class Login extends Activity {
    ...
    //this method gets invoked upon clicking the log in button
    public void onLogin(View view){
            if (view.getId()==R.id.loginButton){
                ...
                //validation logic for the username and password
                if((str1.equals("Admin")) && (str2.equals("Admin"))) {
                    //if the credentials are correct it redirects to the maps activity
